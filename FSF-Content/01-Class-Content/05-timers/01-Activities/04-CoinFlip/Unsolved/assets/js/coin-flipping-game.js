    ...
    function flipThatCoin(result) {
      ...
      var $imgCoin = $("<img>");
      if(randNum === 0) {
        $imgCoin.attr("src", "http://random-ize.com/coin-flip/us-quarter/us-quarter-front.jpg");
      } else {
        $imgCoin.attr("src", "http://random-ize.com/coin-flip/us-quarter/us-quarter-back.jpg");
      }
      $("#coin-image").html($imgCoin);
